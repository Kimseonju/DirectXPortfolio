...
public:
    ...
    void SetParticleSpawnTime(const std::string& Name, float SpawnTime);

    void SetParticleUpdateShader(const std::string& Name, const std::string& ShaderName);
    CParticleUpdateShader* GetParticleUpdateShader(const std::string& Name);
