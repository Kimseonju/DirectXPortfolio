...
void CParticleSystem::SetTwinkleEnable(bool Enable)
{
	int	Twinkle = Enable ? 1 : 0;

	m_CBuffer->SetTwinkleEnable(Twinkle);
}
...
void CParticleSystem::SetUpdateShader(const std::string& Name)
{
