...
public:
	...
	static bool CollisionLine2DToBox2D(HitResult& SrcResult, HitResult& DestResult,
		const Line2DInfo& Src, const Box2DInfo& Dest);

	static bool CollisionLine2DToPoint(HitResult& SrcResult, HitResult& DestResult,
		const Line2DInfo& Src, const Vector2& Dest);
