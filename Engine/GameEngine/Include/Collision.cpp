...
bool CCollision::CollisionLine2DToBox2D(HitResult& SrcResult, HitResult& DestResult, const Line2DInfo& Src, const Box2DInfo& Dest)
{
	Vector2 CenterDir = Src.Center - Dest.Center;
...
bool CCollision::CollisionLine2DToPoint(HitResult& SrcResult, HitResult& DestResult, const Line2DInfo& Src, const Vector2& Dest)
{
	return false;
}
